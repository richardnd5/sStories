...
//        okayButton.bottomAnchor.constraint(equalTo: bottomAnchor).isActive = true
...
//        downArrow.heightAnchor.constraint(equalTo: downArrow.widthAnchor, multiplier: 1).isActive = true
//        downArrow.widthAnchor.constraint(equalToConstant: frame.width/6).isActive = true
//        downArrow.widthAnchor.constraint(equalTo: downArrow.heightAnchor, multiplier: 1).isActive = true
//        downArrow.heightAnchor.constraint(equalToConstant: size.height).isActive = true
